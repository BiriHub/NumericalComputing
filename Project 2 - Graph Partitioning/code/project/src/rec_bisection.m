...
%   of the 2-way edge separator function to call. 
...
%	arg2 is special: If it has the same number of rows as A, then the recursivecalls use the appropriate subset of arg2 as well as of A.
% 	This is useful if the partitioner uses xy coords.
%   map is a vector of integers from 0 to 2^levels-1, indexed by vertex, giving the partition number for each
%   vertex.
